...
2. 计算 $e(\gamma)$ 和 $\mu(\gamma)$ 并绘图，与已知的强耦合（ $\gamma\to\infty$ ）和弱耦合（ $\gamma\to0$ ）渐近表达式进行比较。
...
$$
x = \frac{\tilde\mu}{2\gamma^2}, \quad y = \frac{1}{\gamma},
$$
...
- $\gamma \to \infty$（强耦合，费米化极限）: $n = \sqrt{\frac{2m\mu}{\pi^2\hbar^2}} \quad\Rightarrow\quad y = \sqrt{\frac{2x}{\pi^2}}$ ,

- $\gamma \gg 1$（强耦合领头阶+次领头阶）: $n = \sqrt{\frac{2m\mu}{\pi^2\hbar^2}} + \frac{8\mu}{3\pi g} - \frac{2\sqrt{2}\hbar\mu^{1.5}}{\pi^2 g^2\sqrt{m}}$ ,

- $\gamma \to 0$（弱耦合，平均场极限）: $n = \frac{\mu}{g} \quad\Rightarrow\quad y = x$ ,

- $\gamma \ll 1$（弱耦合领头阶+次领头阶）: $n = \frac{\mu}{g} + \frac{1}{\pi}\sqrt{\frac{m\mu}{\hbar^2}}$ .
